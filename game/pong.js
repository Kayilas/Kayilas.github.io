...
ballSprite.src = 'stickerL.png'; // Ball Sprite
const paddleSprite = new Image();
paddleSprite.src = 'line.jpg'; // Paddle Sprite
...
function aiControl() {
    ...
    if (ball.speedX < 0) { // Only control AI when ball is moving towards the left paddle (Should probably remove this to make it smarter(?) maybe)
...
function gameLoop() {
    ...
    // Move paddles
    if (keys['KeyW']) rightPaddle.move(true);
